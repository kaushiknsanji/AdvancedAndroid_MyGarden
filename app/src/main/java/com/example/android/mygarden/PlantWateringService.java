...
public class PlantWateringService extends IntentService {
    ...
    private void handleActionWaterPlant(long plantId) {
        Uri SINGLE_PLANT_URI = ContentUris.withAppendedId(PlantContract.PlantEntry.CONTENT_URI, plantId);
    ...
    private void handleActionUpdatePlantWidgets() {
        ...
        boolean showWaterButton  = false; //Defaulted to False to hide the water button
        ...
        if (cursor != null && cursor.getCount() > 0) {
            ...
            showWaterButton = (timeNow - wateredAt) > PlantUtils.MIN_AGE_BETWEEN_WATER && (timeNow - wateredAt) < PlantUtils.MAX_AGE_WITHOUT_WATER;
